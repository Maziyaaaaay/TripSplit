    ...
    <div className="px-6 pb-28">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <div className="text-[19px] font-extrabold text-[#0B0B0F]">Expenses</div>
        </div>
        <button
          onClick={() => setSheet("add")}
          className="w-11 h-11 rounded-full bg-[#0B0B0F] text-white flex items-center justify-center cursor-pointer"
        >
